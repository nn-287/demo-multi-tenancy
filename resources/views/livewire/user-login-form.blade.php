                    ...
                    <div class="grid gap-4 lg:gap-6">
                        <div>
                            ...
                            <input type="email" 
                                wire:model="email" 
                                id="email" 
                                class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm text-black focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
                            @error('email') <em class="text-red-500">{{$message}}</em> @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="password" 
                                ...
                                id="password" 
                                class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm text-black focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
                            @error('password') <em class="text-red-500">{{$message}}</em> @enderror
                        </div>
